...
import GiftIMG from '../assets/GiftBox/GiftIMG.png';
...
const Card = ({ title, description, price }) => (
  <div className='flex flex-col bg-[#FFFBF6] w-auto h-auto rounded-[50px] p-4 items-center text-center justify-center border border-[#c4c4c4]'>
    <img src={GiftIMG} className="bg-center bg-cover rounded-[40px]" alt="Gift" />
    <div className='mt-4'>
...
const NewArivale = () => {
  const cards = [
    ...
    { title: 'Gift Box 05', description: 'Description here', price: 'Rs.3,800.00' },
    { title: 'Gift Box 06', description: 'Description here', price: 'Rs.4,000.00' },
    { title: 'Gift Box 07', description: 'Description here', price: 'Rs.2,600.00' },
    { title: 'Gift Box 08', description: 'Description here', price: 'Rs.4,200.00' },
  ];

  return (
    <div className='relative flex flex-col h-auto p-4 md:p-10 bg-white bg-center'>
